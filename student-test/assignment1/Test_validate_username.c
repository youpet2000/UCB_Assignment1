...
void test_validate_my_username()
{
    ...
    const char *string1ptr;
    const char *string2ptr;

    string1ptr = my_username();
    string2ptr = malloc_username_from_conf_file();
    
    //TEST_ASSERT_TRUE_MESSAGE(false,"AESD students, please fix me!");
    TEST_ASSERT_EQUAL_STRING_MESSAGE(string1ptr, string2ptr, "Wrong Username");
}
